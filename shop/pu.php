...
<body>
	<div class="header">
    	<div class="pic">
			<img src="../四海遊龍/images/pu.PNG">
		</div>
   		<nav class="navbar fixed-top">
		 	<ul>
		 		<li class="active"><a href="../雙溪店家頁面/index.php">首頁</a></li>
		 		<li><a href="#set">套餐</a></li>
		 		<li><a href="#noodle">炒泡麵</a></li>
		 		<li><a href="#fast">快餐</a></li>
		 		<li><a href="#order">其他</a></li>
...
<div class="content">
	...
	<h2 id="set">套餐</h2>
<?php
$result = $conn->query("SELECT * FROM products limit 61,6");
if($result->num_rows > 0){
	while($row = $result->fetch_assoc()){
		...
		<tr>
			...
			<a href="../購物車/action.php?action=addToCart&id=<?php echo $row["id"];?>" class="img"><div class="img1"><img src="../四海遊龍/images/cart.PNG"></a></div>
			</td>
		</tr>
	<?php }
}else{?>
...
?>
	...
	<h2 id="noodle">炒泡麵</h2>
<?php
$result = $conn->query("SELECT * FROM products limit 67,7");
if($result->num_rows > 0){
	while($row = $result->fetch_assoc()){
		?>
		<tr>
			...
			<a href="../購物車/action.php?action=addToCart&id=<?php echo $row["id"];?>" class="img"><div class="img1"><img src="../四海遊龍/images/cart.PNG"></a></div></td>
		</tr>
	<?php }
}else{?>
<p>Product not found.....</p>
...
?>
	...
	<h2 id="fast">快餐</h2>
<?php
$result = $conn->query("SELECT * FROM products limit 74,10");
if($result->num_rows > 0){
	while($row = $result->fetch_assoc()){
		?>
		<tr>
			...
			<td style="text-align: center"><?php echo $row['price']?></td>
			<td style="font-size:60% ;color: red;text-align:center">
			<a href="../購物車/action.php?action=addToCart&id=<?php echo $row["id"];?>" class="img"><div class="img1"><img src="../四海遊龍/images/cart.PNG"></a></div></td>		</tr>
	<?php }
}else{?>
<p>Product not found.....</p>
</table>
...
<?php
$result = $conn->query("SELECT * FROM products limit 84,7");
if($result->num_rows > 0){
	while($row = $result->fetch_assoc()){
		?>
		<tr>
