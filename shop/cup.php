...
<body>
	<div class="header">
    	<div class="pic">
			<img src="../四海遊龍/images/001.PNG">
		</div>
   		<nav class="navbar fixed-top">
		 	<ul>
		 		<li class="active"><a href="../雙溪店家頁面/index.php">首頁</a></li>
		 		<li><a href="#1">超值套餐</a></li>
		 		<li><a href="#2">漢堡</a></li>
		 		<li><a href="#3">潛艇堡</a></li>
		 		<li><a href="#4">吐司</a></li>
		 		<li><a href="#5">點心類</a></li>
		 		<li><a href="#6">墨西哥生菜捲</a></li>
		 		<li><a href="#7">飲料</a></li>
...
<h2 id="1">超值套餐</h2>
<?php
	$result = $conn->query("SELECT * FROM products limit 91,19");
...
<?php
$result = $conn->query("SELECT * FROM products limit 110,8");
if($result->num_rows > 0){
	while($row = $result->fetch_assoc()){
		?>
		<tr>
...
<?php
$result = $conn->query("SELECT * FROM products limit 118,4");
if($result->num_rows > 0){
	while($row = $result->fetch_assoc()){
		?>
		<tr>
...
<h2 id="4">吐司</h2>
<?php
$result = $conn->query("SELECT * FROM products limit 122,16");
if($result->num_rows > 0){
	while($row = $result->fetch_assoc()){
		?>
		<tr>
...
<?php
$result = $conn->query("SELECT * FROM products limit 138,19");
if($result->num_rows > 0){
	while($row = $result->fetch_assoc()){
		?>
		<tr>
...
<h2 id="6">墨西哥生菜捲</h2>
<?php
$result = $conn->query("SELECT * FROM products limit 157,3");
if($result->num_rows > 0){
	while($row = $result->fetch_assoc()){
		?>
		<tr>
...
<h2 id="7">飲料</h2>
<?php
$result = $conn->query("SELECT * FROM products limit 160,5");
if($result->num_rows > 0){
	while($row = $result->fetch_assoc()){
		?>
		<tr>
