...
<body>
	...
	<h1>金鶴餃舍</h1>
<div class="meal">
<table border="1" height="320px" width="550px" class="set">
...
<h2 id="1">餃子類</h2>
<?php
$result = $conn->query("SELECT * FROM products limit 208,3");
...
<?php }
?>
<table border="1" height="150px" width="550px" class="noodle">
	<td  width="79%" style="font-size: 80%;text-align: center">餐點</td>
	<td width="10%" style="font-size: 80%;text-align: center">價格</td>
...
<?php
$result = $conn->query("SELECT * FROM products limit 211,1");
if($result->num_rows > 0){
	while($row = $result->fetch_assoc()){
		?>
		<tr>
...
<?php
$result = $conn->query("SELECT * FROM products limit 212,14");
if($result->num_rows > 0){
	while($row = $result->fetch_assoc()){
		?>
		<tr>
...
<h2 id="4">麵類</h2>
<?php
$result = $conn->query("SELECT * FROM products limit 226,17");
if($result->num_rows > 0){
	while($row = $result->fetch_assoc()){
		?>
		<tr>
...
<h2 id="5">湯類</h2>
<?php
$result = $conn->query("SELECT * FROM products limit 243,7");
if($result->num_rows > 0){
	while($row = $result->fetch_assoc()){
		?>
		<tr>
